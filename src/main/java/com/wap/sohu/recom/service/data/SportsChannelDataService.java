...
@Service("sportsChannelDataService")
public class SportsChannelDataService implements ChannelNewsDataService {
    ...
    public static final String key = String.format(CommonConstants.CHANNEL_SEPARATE_ZSET, CommonConstants.SPORTS_CHANNEL_ID);

    public static final String editorNewsKey = String.format(CommonConstants.EDITOR_CHANNEL_NEWS, CommonConstants.SPORTS_CHANNEL_ID);
    ...
    @PostConstruct
    public void init(){
        ChannelDataServiceRegister.registerService( CommonConstants.SPORTS_CHANNEL_ID, this);
    }
    ...
    private Set<Integer> getRecommendData(String key, int start,int count){
        ICache<String, Set<Integer>> iCache =  TopNewsCacheManager.getSportsChannelNews();
    ...
    private Set<Integer> getEditorNews(){
        ICache<String, Set<Integer>> iCache = TopNewsCacheManager.getSportsEditorChannelNews();
