...
@Service("internationalChannelDataService")
public class InternationalChannelDataService implements ChannelNewsDataService {
    ...
    public static final String key = String.format(CommonConstants.CHANNEL_SEPARATE_ZSET, CommonConstants.INTERNATIONAL_CHANNEL_ID);

    public static final String editorNewsKey = String.format(CommonConstants.EDITOR_CHANNEL_NEWS, CommonConstants.INTERNATIONAL_CHANNEL_ID);

    @PostConstruct
    public void init(){
        ChannelDataServiceRegister.registerService( CommonConstants.INTERNATIONAL_CHANNEL_ID, this);
    }
    ...
    private Set<Integer> getRecommendData(String key, int start,int count){
        ICache<String, Set<Integer>> iCache =  TopNewsCacheManager.getInternationalChannelNews();
    ...
    private Set<Integer> getEditorNews(){
        ICache<String, Set<Integer>> iCache = TopNewsCacheManager.getInternationalEditorChannelNews();
